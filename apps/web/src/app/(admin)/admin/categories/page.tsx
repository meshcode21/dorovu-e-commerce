...
export default function AdminCategoriesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-display font-bold text-ink">Product Categories</h1>
        <p className="text-ink-60 text-sm mt-1">Manage the categories available to crafters when listing products.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl border border-sand p-6 shadow-sm sticky top-6">
            <h2 className="text-lg font-medium text-ink mb-4">Add New Category</h2>
                  ...
                  {categories.map((category) => (
                    <tr key={category.id} className="hover:bg-sand/10 transition-colors">
                      ...
                      <td className="px-6 py-4 text-ink-60">
                        {category.description || <span className="italic text-ink-40">No description</span>}
                      </td>
