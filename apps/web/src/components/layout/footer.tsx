...
export function Footer() {
  return (
    <footer className="bg-sand border-t border-ink-30/20 pt-16 pb-8">
      <div className="max-w-[1280px] mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          <h3 className="font-display font-semibold text-ink mb-4">Shop</h3>
        ...
        <div>
          <h3 className="font-display font-semibold text-ink mb-4">Sell</h3>
          <ul className="space-y-3 text-sm text-ink-60">
        ...
        <div>
          <h3 className="font-display font-semibold text-ink mb-4">Help</h3>
          <ul className="space-y-3 text-sm text-ink-60">
      ...
      <div className="max-w-[1280px] mx-auto px-4 pt-8 border-t border-ink-30/20 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-ink-60">
